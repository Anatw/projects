/*******************************************************************************
This c file contain function needed to activate and run the watchdog. You must link your files with the libsched.so - the library of the scheduler with it's dependencies.
