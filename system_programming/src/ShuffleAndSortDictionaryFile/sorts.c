...
March 30-31, 2020
MergeSort + Qsort: 14-15 of April, 2020
*******************************************************************************/
...
void InsertionSort(int array[], size_t array_length)
{
    ...
    for (index = 1; index < array_length; ++index)
    {
        ...
        /* Swap inside the current couple if needed, and go back till the
         * baggining of the array - swapping as needed: */
