...
/* 
* Hash Table Remove: search for a specific element in the
hase table and removes it from table
...
* Return: pointer to the element found, NULL if no element found
* Time Complexity: best & avarage case: O(1) worst case: O(n)
*/
...
* Return: table's standard deviation - # of elements / # of buckets
* Time Complexity: O(n)
*/
