...
#include <stdlib.h>
#include <limits.h>                               /*חסר הסבר על כל הספריה למה נקראה ולמה משמשת  */
...
/******************************************************************************/
bit_array_t Mirror(bit_array_t array)         /* Where is the realization of MIRROR without the LUT where is?????????1!!!!!!!! :( */
{
