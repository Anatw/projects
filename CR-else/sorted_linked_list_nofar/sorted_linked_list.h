...
* Receive: is_before function that recieves 2 void pointers to data and returns
* 		   1 if data1 is sorted before data2, 0 if not.
...
* Time Complexity: O(1) in error- o(n)
*/
...
* Recieve: 1. dsll_t *list which points to dsll_t manager struct
* Return: dsll_iter_t that points to the last dummy element from the list
* Time Complexity: O(1) 
*/
...
*			  0 if false.
*		   4. const void *data to compare with
