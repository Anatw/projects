/*******************************************************************************
 * File: binary_search_tree.h - Binary Search Tree header file				   *
...
* Receive: tree - pointer to bst_t tree
* Return: bst_iter_t iterator at the root of the tree
...
* Return: bst_iter_t iterator at the next element
* Time Complexity: O(n)
*/
bst_iter_t BSTNext(const bst_iter_t iterator);

/*
* Binary Search Tree Previous: Get previous iterator
* Receive: iterator - at the element to get its previous
* Return: bst_iter_t iterator at the previous element
* Time Complexity: O(n)
*/
