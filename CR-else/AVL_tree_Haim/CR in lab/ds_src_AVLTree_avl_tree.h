...
Recieve: compare function: /* cmp_func 
...
Recieve:1. avl tree /* tree - information...
		2. data to insert /* data - new data to insert into tree.
Complexity: O(log(n))
*/
...
/*
Purpose: Get the max height of the avl tree - from root to bottom
