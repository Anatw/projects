...
Complexity: O(log(n))
*/
node_t *AVLSearchAndDelete(node_t *node, void *data);
...
Complexity: O(n)
*/
node_t *AVLFindSuccessor(node_t *node); /* FindPrevSuccessor
...
void AVLRemove(avl_t *tree, const void *data)
{
	...
	AVLSearchAndDelete(tree->root, (void *)data);
...
void AVLPostOrderDestroy(node_t *node) /* void? */
{
	if (NULL != node)
	{
